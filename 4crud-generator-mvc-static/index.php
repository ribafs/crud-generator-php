    ...
    <div class="panel panel-default">
        ...
        <div class="row">
            ...
            <div class="text-left col-md-2 top">
                <a href="views/insert.php?table=<?=DB::TABLE?>" class="btn btn-primary pull-left">
                ...
                <form action="views/search.php" method="get" >
                  ...
                  <span class="pull-right">  
                    <label class="control-label" for="palavra" style="padding-right: 5px;">
                      ...
                      <input name="table" type="hidden" value="<?=DB::TABLE?>">
                    </label>
...
$(document).ready(function() {
    $("#pg-results").load("views/fetch_data.php?table=<?=DB::TABLE?>");
    $(".pagination").bootpag({
        ...
        $("#pg-results").load("views/fetch_data.php?table=<?=DB::TABLE?>", {"page": page_num});
    });
});
</script>
