...
class Connection
{
	...
	private $db    = 'testes';
	private $user  = 'postgres';// root, postgres
	private $pass  = 'postgres'; // postgres
	public  $sgbd  = 'pgsql'; // mysql, pgsql
	private $port  = '5432'; // 3306, 5432
	public  $table = 'customers';

	public  $pdo;
	public $regsPerPage = 8; // Registros por página
    public $linksPerPage = 23;
    public $appName = 'Gerador de CRUDs com PHPOO</a>';
